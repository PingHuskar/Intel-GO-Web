...
const BRANDS = {
    ...
    "JIB": {
        ...
        "branches": [
            {name: "เซียร์ เจ.ไอ.บี", name_th: "เซียร์ เจ.ไอ.บี", tel: "02-992-7241 ", geo: [13.960866,100.621902], addr: "เลขที่ 99 หมู่ 8 ศูนย์การค้าเซียร์ รังสิต ห้องเลขที่ SBSB115-116, SB146-147, SB151, SB172, SB173-174 ชั้น 2 ถนนพหลโยธิน"},
            {name: "เซียร์ เค.โอ.บี", name_th: "เซียร์ เค.โอ.บี", tel: "02-992-7243", geo: [13.960866,100.621902], addr: "เลขที่ 99 หมู่ 8 ศูนย์การค้าเซียร์ รังสิต ห้องเลขที่ SC215 ชั้น 2 ถนนพหลโยธิน"},
            {name: "เซียร์ GAMING", name_th: "เซียร์ GAMING", tel: "-", geo: [13.960866,100.621902], addr: "เลขที่ 99 หมู่ 8 ศูนย์การค้าเซียร์ รังสิต ห้องเลขที่ SA056-SA057 ชั้น 2 ถนนพหลโยธิน "},
            {name: "เซียร์ ไฮ-เอน", name_th: "เซียร์ ไฮ-เอน", tel: "02-992-6745", geo: [13.960866,100.621902], addr: "เลขที่ 99 หมู่ 8 ศูนย์การค้าเซียร์ รังสิต ห้องเลขที่ TB030,TB031 ชั้น 3 ถนนพหลโยธิน"},
            {name: "เซียร์ กิ๊ฟซี่", name_th: "เซียร์ กิ๊ฟซี่", tel: "02-992-6051 ถึง 55", geo: [13.960866,100.621902], addr: "เลขที่ 99 หมู่ 8 ศูนย์การค้าเซียร์ รังสิต ห้องเลขที่ SA018 A-C ชั้น 2 ถนนพหลโยธิน"},
            {name: "เซียร์ เมกก้าช็อป", name_th: "เซียร์ เมกก้าช็อป", tel: "-", geo: [13.960866,100.621902], addr: "เลขที่ 99 หมู่ 8 ศูนย์การค้าเซียร์ รังสิต ห้องเลขที่ GB153 ชั้น G ถนนพหลโยธิน"},
            {name: "INSIDE IT CARE (เซียร์ รังสิต)", name_th: "INSIDE IT CARE (เซียร์ รังสิต)", tel: "02-992-7201", geo: [13.960866,100.621902], addr: "เลขที่ 99 หมู่ 8 ศูนย์การค้าเซียร์ รังสิต ห้องเลขที่ GB153 ชั้น G ถนนพหลโยธิน "},
            {name: "GG PLAZA", name_th: "GG PLAZA", tel: "-", geo: [13.95786873658442,100.62156545192752], addr: "เลขที่ 801/2 ซอยพหลโยธิน 72 "},
            {name: "โคราช 1 (ไอทีพลาซ่า)", name_th: "โคราช 1 (ไอทีพลาซ่า)", tel: "044-269-728", geo: [14.980132,102.096929], addr: "เลขที่ 324 ศูนย์การค้าไอที พลาซ่า ห้องเลขที่ 204, 205 ชั้น 2 ถนนมิตรภาพ"},
            {name: "เดอะมอลล์ โคราช JIB", name_th: "เดอะมอลล์ โคราช JIB", tel: "044-394-435", geo: [14.980241,102.075930], addr: "เลขที่ 1242/2 ศูนย์การค้าเดอะมอลล์ โคราช ห้องเลขที่ 3F-14 ชั้น 3 ถนนมิตรภาพ"},
            {name: "สกลนคร (CB)", name_th: "สกลนคร (CB)", tel: "042-713-877", geo: [17.1656074,104.1429672], addr: "เลขที่ 1469/3 ถนนรัฐพัฒนา"},
            {name: "นครพนม (CB)", name_th: "นครพนม (CB)", tel: "042-512-600", geo: [17.4034445,104.7857205], addr: "เลขที่ 89 ถนนเฟื่องนคร"},
            {name: "ศรีสะเกษ (CB)", name_th: "ศรีสะเกษ (CB)", tel: "045-616-256", geo: [15.109705,104.330034], addr: "เลขที่ 1139 ถนนขุขันธ์"},
            {name: "สุรินทร์ (CB)", name_th: "สุรินทร์ (CB)", tel: "-", geo: [14.888117,103.494089], addr: "เลขที่ 251/2-3 ถนนหลักเมือง"},
            {name: "หนองคาย (ไอทีอัศวรรณ)", name_th: "หนองคาย (ไอทีอัศวรรณ)", tel: "042-465-304", geo: [17.874602,102.742714], addr: "เลขที่ 309 หมู่ 10 ศูนย์การค้าไอทีอัศวรรณ ชั้น 2 ห้องเลขที่ P5-A-10 ชั้น 2 ถนนมิตรภาพ"},
            {name: "บุรีรัมย์ (โรบินสัน)", name_th: "บุรีรัมย์ (โรบินสัน)", tel: "044-600-727", geo: [14.9731673,103.0641685], addr: "เลขที่ 125 หมู่ 6 ห้างสรรพสินค้าโรบินสัน บุรีรัมย์ ห้องเลขที่ 212 ชั้น 2 (IT ZONE)"},
            {name: "เซ็นทรัล อุดรธานี 2", name_th: "เซ็นทรัล อุดรธานี 2", tel: "042-921-475", geo: [17.4057443,102.8004192], addr: "เลขที่ 277/1-3, 271/5 ศูนย์การค้าเซ็นทรัลพลาซา อุดรธานี ห้องเลขที่ 230-231 ชั้น 2 ถนนประจักษ์ศิลปกร"},
            {name: "มหาสารคาม (เสริมไทยคอมเพล็กซ์)", name_th: "มหาสารคาม (เสริมไทยคอมเพล็กซ์)", tel: "043-970-619", geo: [16.201786,103.276749], addr: "เลขที่ 76/1-7 ศูนย์การค้าเสริมไทยคอมเพล็กซ์ ห้องเลขที่ R205 ชั้น 2 ถนนนครสวรรค์"},
            {name: "อุดรธานี 4 (ตึกคอม)", name_th: "อุดรธานี 4 (ตึกคอม)", tel: "042-247-560", geo: [17.408857,102.792807], addr: "เลขที่ 71/29 ศูนย์การค้าตึกคอมแลนด์มาร์ค อุดรธานี ห้องเลขที่ 2R16-2R19 ชั้น 2 โซนไอที ถนนอุดรดุษฎี"},
            {name: "เซ็นทรัล อุบลราชธานี JIB", name_th: "เซ็นทรัล อุบลราชธานี JIB", tel: "045-422-494", geo: [15.240119,104.8232428], addr: "เลขที่ 311 หมู่ 7 ศูนย์การค้าเซ็นทรัลพลาซา อุบลราชธานี ห้องเลขที่ 222 ชั้น 2 "},
            {name: "ร้อยเอ็ด (โรบินสัน)", name_th: "ร้อยเอ็ด (โรบินสัน)", tel: "043-540-940", geo: [16.0600725,103.6174826], addr: "เลขที่ 137 หมู่ 3 ห้างสรรพสินค้าโรบินสัน ร้อยเอ็ด ห้องเลขที่ 2F-B-209 ชั้น 2F"},
            {name: "มุกดาหาร (CB)", name_th: "มุกดาหาร (CB)", tel: "042-611-771", geo: [16.5505941,104.7204603], addr: "เลขที่ 89/10 ถนนวิวิธสุรการ"},
            {name: "ขอนแก่น 2 (ตึกคอม)", name_th: "ขอนแก่น 2 (ตึกคอม)", tel: "-", geo: [16.429682,102.831109], addr: "เลขที่ 250/1 ศูนย์การค้าตึกคอม โฆษะ ห้องเลขที่ 3R134-137 ชั้น 3 ถนนศรีจันทร์"},
            {name: "เซ็นทรัล ขอนแก่น 1", name_th: "เซ็นทรัล ขอนแก่น 1", tel: "043-288-235", geo: [16.4329489,102.8257675], addr: "เลขที่ 99,99/1 ศูนย์การค้าเซ็นทรัลพลาซา ขอนแก่น ห้องเลขที่ 338 ชั้น 3 ถนนศรีจันทร์"},
            {name: "ยโสธร (CB)", name_th: "ยโสธร (CB)", tel: "045-711-063", geo: [15.794965,104.1424444], addr: "เลขที่ 244 ถนนแจ้งสนิท"},
            {name: "เทอมินอล 21 โคราช MINE", name_th: "เทอมินอล 21 โคราช MINE", tel: "044-498-613", geo: [14.9814713,102.0883824], addr: " เลขที่ 99 ศูนย์การค้าเทอมินอล 21 โคราช ห้องเลขที่ 3004 ชั้น 3 ถนนมิตรภาพ-หนองคาย"},
            {name: "เซ็นทรัล โคราช", name_th: "เซ็นทรัล โคราช", tel: "044-229-309", geo: [14.9978976,102.1130208], addr: "เลขที่ 990,998 ศูนย์การค้าเซ็นทรัลพลาซา นครราชสีมา ห้องเลขที่ 208-209 ชั้น 2 ถนนมิตรภาพ-หนองคาย"},
            {name: "ชัยภูมิ (โรบินสัน)", name_th: "ชัยภูมิ (โรบินสัน)", tel: "-", geo: [15.787255,102.030725], addr: "เลขที่ 299/9 ห้างสรรพสินค้าโรบินสัน ชัยภูมิ ห้องเลขที่ 218 ชัน 2 หมู่ 6 "},
            {name: "เดอะมอลล์ โคราช MINE", name_th: "เดอะมอลล์ โคราช MINE", tel: "-", geo: [14.980716,102.076401], addr: "เลขที่ 1242/2 ศูนย์การค้าเดอะมอลล์ นครราชสีมา ห้องเลขที่ 3F-16 ชั้น 3 ถนนมิตรภาพ "},
            {name: "เลย (CB)", name_th: "เลย (CB)", tel: "-", geo: [17.4899858,101.7236872], addr: "เลขที่ 12/3 ถนนร่วมใจ "},
            {name: "เซ็นทรัล ขอนแก่น 2", name_th: "เซ็นทรัล ขอนแก่น 2", tel: "-", geo: [16.4329489,102.8257675], addr: "เลขที่ 99,99/1 ศูนย์การค้าเซ็นทรัลพลาซา ขอนแก่น เลขที่ 330-332 ชั้น 3 ถนนศรีจันทร์"},
            {name: "อำนาจเจริญ (CB)", name_th: "อำนาจเจริญ (CB)", tel: "-", geo: [15.8646137,104.6276299], addr: "เลขที่ 288/80 หมู่ 9"},
            {name: "เซ็นทรัล อุบลราชธานี MINE", name_th: "เซ็นทรัล อุบลราชธานี MINE", tel: "-", geo: [15.240119,104.8232428], addr: "เลขที่ 311 หมู่ 7 ศูนย์การค้าเซ็นทรัลพลาซา อุบลราชธานี ห้องเลขที่ 206 ชั้น 2 "},
            {name: "ศรีราชา 1 (ตึกคอม)", name_th: "ศรีราชา 1 (ตึกคอม)", tel: "-", geo: [13.162266,100.928454], addr: "เลขที่ 135/99 ศูนย์การค้าตึกคอม ศรีราชา ห้องเลขที่ 229-230, 251 ชั้น 2 ถนนสุขุมวิท"},
            {name: "พัทยา 1 (ตึกคอม)", name_th: "พัทยา 1 (ตึกคอม)", tel: "038-724-184", geo: [12.923714,100.878683], addr: "เลขที่ 9 หมู่ 10 ศูนย์การค้าตึกคอม พัทยาใต้ ห้องเลขที่ 3R10-15 ชั้น 3 ถนนพัทยาใต้ "},
            {name: "ศรีราชา 2 (ตึกคอม)", name_th: "ศรีราชา 2 (ตึกคอม)", tel: "-", geo: [13.162266,100.928454], addr: "เลขที่ 135/99 ศูนย์การตึกคอม ศรีราชา ห้องเลขที่ 207-210 ชั้น 2 ถนนสุขุมวิท"},
            {name: "เซ็นทรัล ชลบุรี", name_th: "เซ็นทรัล ชลบุรี", tel: "038-053-875", geo: [13.335181,100.970331], addr: "เลขที่ 55/88-89, 55/91 หมู่ 1 ศูนย์การค้าเซ็นทรัลพลาซา ชลบุรี ห้องเลขที่ 204 ชั้น 2 "},
            {name: "ชลบุรี 1 (ตึกคอม)", name_th: "ชลบุรี 1 (ตึกคอม)", tel: "038-184-046", geo: [13.341134,100.973416], addr: "เลขที่ 97/223 หมู่ 1 ศูนย์การค้าตึกคอม ชลบุรี ห้องเลขที่ 3R118-3R120 ชั้น 3 "},
            {name: "ระยอง (สตาร์ ระยอง)", name_th: "ระยอง (สตาร์ ระยอง)", tel: "038-610-974", geo: [12.686151,101.269569], addr: "เลขที่ 115 ศูนย์การค้าสตาร์ ระยอง ห้องเลขที่ 1102-1104 ชั้น 1 ซอยศูนย์การค้าสาย 4 ถนนสุขุมวิท"},
            {name: "ปราจีนบุรี 1 (โรบินสัน)", name_th: "ปราจีนบุรี 1 (โรบินสัน)", tel: "037-454-762", geo: [14.0589195,101.3959373], addr: "เลขที่ 72 หมู่ 3 ห้างสรรพสินค้าโรบินสัน ปราจีนบุรี ห้องเลขที่ 2F-B-208 ชั้น 2F"},
            {name: "เซ็นทรัล ระยอง", name_th: "เซ็นทรัล ระยอง", tel: "038-942-668", geo: [12.845444,101.136875], addr: "เลขที่ 99 ศูนย์การค้าเซ็นทรัลพลาซา ระยอง ห้องเลขที่ 251/1 ถ.บางนา-ตราด"},
            {name: "พัทยา 3 (ฮาร์เบอร์)", name_th: "พัทยา 3 (ฮาร์เบอร์)", tel: " 038-196-419 ", geo: [12.9339456248997,100.897660665214], addr: "เลขที่ 190/25 หมู่ที่ 9 ศูนย์การค้าฮาร์เบอร์ พัทยา ห้องเลขที่ 4R09-4R12 ชั้น 4 "},
            {name: "จันทบุรี 1 (CB)", name_th: "จันทบุรี 1 (CB)", tel: "039-603-533", geo: [12.594967,102.108837], addr: "เลขที่ 55 ถนนมหาราช "},
            {name: "ชลบุรี (โรบินสัน อมตะนคร)", name_th: "ชลบุรี (โรบินสัน อมตะนคร)", tel: "038-459-292", geo: [13.4063444,101.0413321], addr: "เลขที่ 888 หมู่ 3 ห้างสรรพสินค้าโรบินสัน ชลบุรี ห้องเลขที่ 220 ชั้น 2 ถนนศุขประยูร"},
            {name: "เทอมินอล 21 พัทยา MINE", name_th: "เทอมินอล 21 พัทยา MINE", tel: "-", geo: [12.9498412,100.8898169], addr: "เลขที่ 456, 777, 777/1 ศูนย์การค้าเทอร์มินอล 21 พัทยา ห้องเลขที่ 1028, 1029 ชั้น 1"},
            {name: "ฮาร์เบอร์มอลล์ แหลมฉบัง", name_th: "ฮาร์เบอร์มอลล์ แหลมฉบัง", tel: "-", geo: [13.0791311,100.9181311], addr: "เลขที่ 4/222 หมู่10 ศูนย์การค้าฮาร์เบอร์มอลล์ แหลมฉบัง ห้องเลขที่ 3A02 ชั้น3 ถนนสุขุมวิท "},
            {name: "ชลบุรี (โรบินสัน บ่อวิน)", name_th: "ชลบุรี (โรบินสัน บ่อวิน)", tel: "-", geo: [13.0401072,101.0807092], addr: "เลขที่ 354 หมู่ 6 ห้างสรรพสินค้าโรบินสัน บ่อวิน ห้องเลขที่ 2F-RR-215 ชั้น 2"},
            {name: "เซ็นทรัล ศรีราชา", name_th: "เซ็นทรัล ศรีราชา", tel: "-", geo: [13.1791171,100.9311785], addr: "เลขที่ 8 ศูนย์การค้าเซ็นทรัลพลาซา ศรีราชา ห้องเลขที่ 210-211 ชัน 2"},
            {name: "บ้านฉาง (โรบินสัน ระยอง)", name_th: "บ้านฉาง (โรบินสัน ระยอง)", tel: "-", geo: [12.7383935,101.0810574], addr: "เลขที่ 162 หมู่ 6 ห้างสรรพสินค้าโรบินสัน บ้านฉาง ห้องเลขที่ 211 ชั้น 2"},
            {name: "เซ็นทรัล จันทบุรี", name_th: "เซ็นทรัล จันทบุรี", tel: "-", geo: [12.5994959,102.123915], addr: "เลขที่ 199 ศูนย์การค้าเซ็นทรัล จันทบุรี ห้องเลขที่ 108 ชั้น 1 ถนนไตรรัตน์"},
            {name: "สระแก้ว (ฺCB)", name_th: "สระแก้ว (ฺCB)", tel: "-", geo: [13.822528,102.065854], addr: "เลขที่ 110 ถนนสุวรรณศร "},
            {name: "โลตัส อมตะนคร", name_th: "โลตัส อมตะนคร", tel: "-", geo: [13.4259413,101.0041879], addr: "เลขที่ 700/75 โลตัส อมตะนคร ห้องเลขที่ 216 ชั้น 2 ถนนเทพรัตน"}, {name: "สงขลา-หาดใหญ่ 1 (CB)", name_th: "สงขลา-หาดใหญ่ 1 (CB)", tel: "074-800-976", geo: [6.994053,100.484262], addr: "เลขที่ 101-103 ถนนโชติวิทยกุล 3 "},
            {name: "สงขลา-หาดใหญ่ 2 (CB)", name_th: "สงขลา-หาดใหญ่ 2 (CB)", tel: "074-559-251", geo: [6.993974,100.484155], addr: "เลขที่ 102,104 ถนนโชติวิทยะกุล 3"},
            {name: "ภูเก็ต (บิ๊กซี)", name_th: "ภูเก็ต (บิ๊กซี)", tel: "-", geo: [7.896335,98.368503], addr: "เลขที่ 72 ศูนย์การค้าบิ๊กซี ซูเปอร์เซ็นเตอร์ ห้องเลขที่ BCR119 ชั้น B ถนนเฉลิมพระเกียรติ"},
            {name: "สงขลา-หาดใหญ่ (บิ๊กซี)", name_th: "สงขลา-หาดใหญ่ (บิ๊กซี)", tel: "074-214-413", geo: [7.038194,100.467007], addr: "เลขที่ 111/19 หมู่ 4 ศูนย์การค้าบิ๊กซี ซูเปอร์เซ็นเตอร์ ห้องเลขที่ 2CR232-234 ชั้น 2 ถนนนิพัทธ์สงเคราะห์ 1"},
            {name: "สตูล (บิ๊กซี)", name_th: "สตูล (บิ๊กซี)", tel: "074-741-983", geo: [6.821444,100.063477], addr: "เลขที่ 959 หมู่ 7 ศูนย์การค้าบิ๊กซี ซูเปอร์เซ็นเตอร์ ห้องเลขที่ GCR 114/2 ชั้น 2"},
            {name: "เซ็นทรัล สุราษฎร์ธานี", name_th: "เซ็นทรัล สุราษฎร์ธานี", tel: "077-602-771", geo: [9.109425,99.289262], addr: "เลขที่ 417 หมู่ 10 ศูนย์การค้าเซ็นทรัลพลาซา สุราษฏร์ธานี ห้องเลขที่ 242 ชั้น 2"},
            {name: "เซ็นทรัล หาดใหญ่", name_th: "เซ็นทรัล หาดใหญ่", tel: "074-339-742", geo: [7.0000859,100.4699953], addr: "เลขที่ 1518, 1518/1, 1518/2 ศูนย์การค้าเซ็นทรัลเฟสติวัล หาดใหญ่ ห้องเลขที่ 309 ชั้น 3 ถนนกาญจนวณิช"},
            {name: "เซ็นทรัล เกาะสมุย", name_th: "เซ็นทรัล เกาะสมุย", tel: "077-410-457", geo: [9.5313045,100.0608232], addr: "เลขที่ 209, 209/1-2 หมู่ 2 ศูนย์การค้าเซ็นทรัลเฟสติวัล สมุย ห้องเลขที่ 204 ชั้น 2 "},
            {name: "นครศรีธรรมราช (CB)", name_th: "นครศรีธรรมราช (CB)", tel: "075-340-609", geo: [8.432619,99.971359], addr: "เลขที่ 101/69 ถนนพัฒนาการคูขวาง"},
            {name: "ชุมพร (CB)", name_th: "ชุมพร (CB)", tel: " 077-630-657 ", geo: [10.4996482,99.186043], addr: "เลขที่ 207/10, 207/11 ถนนกรมหลวงชุมพร"},
            {name: "เซ็นทรัล นครศรีธรรมราช", name_th: "เซ็นทรัล นครศรีธรรมราช", tel: " 075-392-818 ", geo: [8.3821706,99.9696929], addr: "เลขที่ 8,9/8 หมู่ 7 ศูนย์การค้าเซ็นทรัลพลาซา นครศรีธรรมราช ห้องเลขที่ 255 ชั้น 2"},
            {name: "เซ็นทรัล ภูเก็ต ", name_th: "เซ็นทรัล ภูเก็ต ", tel: "076-307-044", geo: [7.8916362,98.3657615], addr: "เลขที่ 199 หมู่ที่ 5 ศูนย์การค้าเซ็นทรัล ภูเก็ต ห้องเลขที่ IT-05 ชั้น 2"},
            {name: "ตรัง TheBiz (CB)", name_th: "ตรัง TheBiz (CB)", tel: "-", geo: [7.5642066,99.6233696], addr: "เลขที่ 136/2-3 ถนนพัทลุง"},
            {name: "หาดใหญ่ ONLINE", name_th: "หาดใหญ่ ONLINE", tel: "063-690-7888", geo: [6.9939492,100.4827739], addr: "เลขที่ 103/1 ถนนโชติวิทยกุล 3"},
            {name: "สหไทย ทุ่งสง", name_th: "สหไทย ทุ่งสง", tel: "-", geo: [8.1603472,99.6755753], addr: "เลขที่ 389 ห้างสหไทยพลาซ่า ห้องเลขที่ F3-07 ชั้น 3"},
            {name: "ปัตตานี (CB)", name_th: "ปัตตานี (CB)", tel: "-", geo: [6.8659639,101.2404929], addr: "เลขที่ 10/21-28 ถนนเจริญประดิษฐ์"},
            {name: "นราธิวาส (CB)", name_th: "นราธิวาส (CB)", tel: "-", geo: [6.4161096,101.8244963], addr: "เลขที่ 261 ถนนระแวะมรรคา "},
            {name: "พัทลุง (CB)", name_th: "พัทลุง (CB)", tel: "-", geo: [7.618629,100.082573], addr: "เลขที่ 151 ถนนราเมศวร "},
            {name: "ยะลา", name_th: "ยะลา", tel: "-", geo: [6.5588103,101.2882155], addr: "เลขที่ 505 ศูนย์การค้าโคลีเซี่ยมยะลา ชั้น 1 ถนนสิโรรส "},
            {name: "ภูเก็ต-ถลาง (โรบินสัน)", name_th: "ภูเก็ต-ถลาง (โรบินสัน)", tel: "-", geo: [7.9807238,98.3622857], addr: "เลขที่ 8/88 หมู่ที่ 5 ห้างสรรพสินค้าโรบิสัน ไลฟ์สไตล์ ภูเก็ต-ถลาง ห้องเลขที่ 202/1 ชั้น 2 ถนนศรีสุนทร"},
            {name: "ระนอง (CB)", name_th: "ระนอง (CB)", tel: "-", geo: [9.9575358,98.631645], addr: "เลขที่ 248/1 ถนนท่าเมือง"},
            {name: "พังงา (CB)", name_th: "พังงา (CB)", tel: "065-223-2180", geo: [8.463128340594276 ,98.53134043514729], addr: "203/3 และ 203/6 ถนนเพชรเกษม"},
            {name: "พันธุ์ทิพย์ 1 ", name_th: "พันธุ์ทิพย์ 1 ", tel: "-", geo: [13.750904,100.537157], addr: "เลขที่ 604/3 ศูนย์การค้าพันธุ์ทิพย์พลาซ่า ประตูน้ำ ห้องเลขที่ 335-339 ชั้น 3 ถนนเพชรบุรี "},
            {name: "พันธุ์ทิพย์ 2", name_th: "พันธุ์ทิพย์ 2", tel: "-", geo: [13.750904,100.537157], addr: "เลขที่ 604/3 ศูนย์การค้าพันธุ์ทิพย์พลาซ่า ประตูน้ำ ห้องเลขที่ 3112,3113,3106/1,3106,3107 ชั้น 3 ถ.เพชรบุรี"},
            {name: "พันธุ์ทิพย์ งามวงศ์วาน ", name_th: "พันธุ์ทิพย์ งามวงศ์วาน ", tel: "-", geo: [13.858942,100.537018], addr: "เลขที่ 217,219 ศูนย์การค้าพันธุ์ทิพย์พลาซ่า งามวงศ์วาน ห้องเลขที่ 4094 ชั้น 4 ถนนงามวงศ์วาน"},
            {name: "เดอะมอลล์ บางกะปิ", name_th: "เดอะมอลล์ บางกะปิ", tel: "02-363-3142", geo: [13.7657948,100.6404827], addr: "เลขที่ 3522 ศูนย์การค้าเดอะมอลล์ บางกะปิ ห้องเลขที่ M3,M4 ชั้น 3 ถนนลาดพร้าว"},
            {name: "พันธุ์ทิพย์ บางกะปิ ", name_th: "พันธุ์ทิพย์ บางกะปิ ", tel: "02-187-3105", geo: [13.766902,100.646613], addr: "เลขที่ 3191-3191/1-428 ศูนย์การค้าพันธุ์ทิพย์พลาซ่า บางกะปิ ห้อง PG10 ชั้น G"},
            {name: "นครปฐม 1 (CB)", name_th: "นครปฐม 1 (CB)", tel: "034-271-394", geo: [13.812449,100.045675], addr: "เลขที่ 28/1-2 ถนนยิงเป้า"},
            {name: "สมุทรปราการ (อิมพีเรียลสำโรง)", name_th: "สมุทรปราการ (อิมพีเรียลสำโรง)", tel: "02-063-3480", geo: [13.649563,100.597008], addr: "เลขที่ 999 หมู่ 1 ห้างไอที พลาซ่า สำโรง ห้องเลขที่ R006 ชั้น 4 ถนนสุขุมวิท"},
            {name: "เซ็นทรัล แจ้งวัฒนะ MINE", name_th: "เซ็นทรัล แจ้งวัฒนะ MINE", tel: "-", geo: [13.904107,100.528196], addr: "เลขที่ 99/99 หมู่ 2 ศูนย์การค้าเซ็นทรัลพลาซา แจ้งวัฒนะ ห้องเลขที่ 430-431 ชั้น 4 ถนนแจ้งวัฒนะ"},
            {name: "เซ็นทรัล พระราม 3", name_th: "เซ็นทรัล พระราม 3", tel: "02-164-0028", geo: [13.697897,100.538233], addr: "เลขที่ 79/147 ศูนย์การค้าเซ็นทรัลพลาซา พระราม 3 ห้องเลขที่ 317/2 ชั้น 3 ถนนสาธุประดิษฐ์"},
            {name: "เซ็นทรัล พระราม 2 MINE", name_th: "เซ็นทรัล พระราม 2 MINE", tel: "02-872-4261", geo: [13.662558,100.437570], addr: "เลขที่ 128 หมู่ 6 ศูนย์การค้าเซ็นทรัลพลาซา พระราม 2 ห้องเลขที่ 342-343 ชั้น 3 ถนนพระราม 2 "},
            {name: "วงศ์สว่าง (บิ๊กซี)", name_th: "วงศ์สว่าง (บิ๊กซี)", tel: "02-587-0086", geo: [13.827180,100.527846], addr: "เลขทื่ 888 ศูนย์การค้าบิ๊กซี ซูเปอร์เซ็นเตอร์ ห้องเลขที่ RB206 ชั้น 2 อาคาร B ถนนพิบูลย์สงคราม"},
            {name: "เซ็นทรัล พระราม 9", name_th: "เซ็นทรัล พระราม 9", tel: "02-160-3862", geo: [13.758055,100.566101], addr: "เลขที่ 9/9 ศูนย์การค้าเซ็นทรัลพลาซา พระราม 9 ห้องเลขที่ 417 ชั้น 4 ถนนพระราม 9"},
            {name: "เมกาบางนา JIB", name_th: "เมกาบางนา JIB", tel: "02-105-1296", geo: [13.6465997,100.6780099], addr: "เลขที่ 39 หมู่ 6 ศูนย์การค้าเมกาบางนา ห้องเลขที่ 2634 ชั้น 2"},
            {name: "เซ็นทรัล แจ้งวัฒนะ JIB", name_th: "เซ็นทรัล แจ้งวัฒนะ JIB", tel: "02-193-8273", geo: [13.904107,100.528196], addr: "เลขที่ 99/99 หมู่ 2 ศูนย์การค้าเซ็นทรัลพลาซา แจ้งวัฒนะ ห้องเลขที่ 413 ชั้น 4 ถนนแจ้งวัฒนะ"},
            {name: "ซีคอน-บางแค", name_th: "ซีคอน-บางแค", tel: "02-458-2983", geo: [13.712292,100.434169], addr: "เลขที่ 607 ศูนย์การค้าซีคอน-บางแค ห้องเลขที่ 358 ชั้น 3 ถนนเพชรเกษม"},
            {name: "เซ็นทรัล ปิ่นเกล้า MINE", name_th: "เซ็นทรัล ปิ่นเกล้า MINE", tel: "02-884-8556", geo: [ 13.778109,100.476233], addr: "เลขที่ 7/222 ศูนย์การค้าเซ็นทรัลพลาซา ปิ่นเกล้า ห้องเลขที่ 307 ชั้น 3 ถนนบรมราชชนนี"},
            {name: "เซ็นทรัล ลาดพร้าว MINE", name_th: "เซ็นทรัล ลาดพร้าว MINE", tel: "-", geo: [13.8162899,100.5588081], addr: "เลขที่ 1693 ศูนย์การค้าเซ็นทรัลพลาซา ลาดพร้าว ห้องเลขที่ K305 ชั้น 3 ถนนพหลโยธิน"},
            {name: "ไอทีสแควร์ หลักสี่ ", name_th: "ไอทีสแควร์ หลักสี่ ", tel: "02-576-1685", geo: [13.887094,100.581742], addr: "เลขที่ 333/100 หมู่ 4 ศูนย์การค้าไอทีสแควร์ หลักสี่ ห้องเลขที่ BS-003/1 ชั้น 2 ถ.แจ้งวัฒนะ"},
            {name: "ซีคอน-ศรีนครินทร์ ", name_th: "ซีคอน-ศรีนครินทร์ ", tel: "-", geo: [13.695349,100.648203], addr: " เลขที่ 5 ศูนย์การค้าซีคอนสแควร์ ห้องเลขที่ ITB18-19 ชั้น B1 ถนนศรีนครินทร์"},
            {name: "เซ็นทรัล บางนา", name_th: "เซ็นทรัล บางนา", tel: "02-399-3148", geo: [13.669350,100.634369], addr: "เลขที่ 585 ศูนย์การค้าเซ็นทรัลพลาซา บางนา ห้องเลขที่ 405 ชัน 4"},
            {name: "เซ็นทรัล ศาลายา (นครปฐม 2)", name_th: "เซ็นทรัล ศาลายา (นครปฐม 2)", tel: "02-429-6901", geo: [13.7868135,100.2761419], addr: "เลขที่ 99/19-20 หมู่ 2 ศูนย์การค้าเซ็นทรัลพลาซา ศาลายา ห้องเลขที่ 239 ชั้น 2"},
            {name: "สมุทรปราการ (โรบินสัน)", name_th: "สมุทรปราการ (โรบินสัน)", tel: "02-174-2721 ", geo: [13.570341,100.641830], addr: "เลขที่ 789 หมู่ 2 ห้างสรรพสินค้าโรบินสัน สมุทรปราการ ห้องเลขที่ 3F-B-305 ชั้น 3F"},
            {name: "เดอะมอลล์ บางแค 3", name_th: "เดอะมอลล์ บางแค 3", tel: "02-482-9566", geo: [13.713566,100.408004], addr: "เลขที่ 275 ศูนย์การค้าเดอะมอลล์ บางแค ห้องเลขที่ IT-F1 ชั้น 3 ถนนเพชรเกษม"},
            {name: "เซ็นทรัล เวสต์เกต MINE", name_th: "เซ็นทรัล เวสต์เกต MINE", tel: "02-194-2793", geo: [13.876609,100.411690], addr: "เลขที่ 199,199/1,199/2 หมู่ 6 ศูนย์การค้าเซ็นทรัลพลาซา เวสต์เกต ห้องเลขที่ 284 ชั้น 2 "},
            {name: "เซ็นทรัล EastVille", name_th: "เซ็นทรัล EastVille", tel: "-", geo: [13.803759,100.613984], addr: "เลขที่ 69,69/1,69/2 ศูนย์การค้าเซ็นทรัลเฟสติวัล อีสต์วิลล์ ห้องเลขที่ 241 ชั้น 2 ถนนประดิษฐมนูธรรม"},
            {name: "ฟิวเจอร์พาร์ค รังสิต", name_th: "ฟิวเจอร์พาร์ค รังสิต", tel: " 02-958-0602-4 ", geo: [13.989181514312895,100.6186209352377], addr: "เลขที่ 94 ศูนย์การค้าฟิวเจอร์พาร์ค รังสิต ห้องเลขที่ PLZ.3.ITS070-073 ชั้น 3 ถนนพหลโยธิน"},
            {name: "แฟชั่น ไอส์แลนด์ JIB", name_th: "แฟชั่น ไอส์แลนด์ JIB", tel: "02-947-5358", geo: [13.8257982,100.679386], addr: "เลขที่ 587,589 ศูนย์การค้าแฟชั่น ไอส์แลนด์ ห้องเลขที่ 3074 ชั้น 3 ถนนรามอินทรา"},
            {name: "สำนักงานใหญ่ ", name_th: "สำนักงานใหญ่ ", tel: "-", geo: [13.9424549,100.6229567], addr: "เลขที่ 21 ถนนพหลโยธิน"},
            {name: "เซ็นทรัล รัตนาธิเบศร์", name_th: "เซ็นทรัล รัตนาธิเบศร์", tel: "02-526-8918", geo: [13.866458,100.496823], addr: "เลขที่ 562,566 ศูนย์การค้าเซ็นทรัลพลาซา รัตนาธิเบศร์ ห้องเลขที่ 203/1 ชั้น 2 ถนนรัตนาธิเบศร์"},
            {name: "เซ็นทรัล ลาดพร้าว ", name_th: "เซ็นทรัล ลาดพร้าว ", tel: " 02-541-1153 ", geo: [13.8162899,100.5588081], addr: "เลขที่ 1693 ศูนย์การค้าเซ็นทรัลพลาซา ลาดพร้าว ห้องเลขที่ 333/1 ชั้น 3 ถนนพหลโยธิน"},
            {name: "แฟชั่น ไอส์แลนด์ MINE", name_th: "แฟชั่น ไอส์แลนด์ MINE", tel: "-", geo: [13.8255476,100.6783843], addr: "เลขที่ 587,589 ศูนย์การค้าแฟชั่น ไอส์แลนด์ ห้องเลขที 3055 ชั้น 3 ถนนรามอินทรา"},
            {name: "เซ็นทรัล มหาชัย", name_th: "เซ็นทรัล มหาชัย", tel: "034-466-840", geo: [13.5724976,100.2888972], addr: "เลขที่ 98 หมู่ 4 ศูนย์การค้าเซ็นทรัลพลาซา มหาชัย ห้องเลขที่ 231 ชั้น 2 "},
            {name: "เซ็นทรัลเวิลด์ MINE", name_th: "เซ็นทรัลเวิลด์ MINE", tel: "02-646-1276", geo: [13.7465966,100.5371728], addr: "เลขที่ 4, 4/1-4/2, 4/4 ศูนย์การค้าเซ็นทรัลเวิลด์ ห้องเลขที่ C402 ชั้น 4 ถนนราชดำริ"},
            {name: "เซ็นทรัล ปิ่นเกล้า", name_th: "เซ็นทรัล ปิ่นเกล้า", tel: "-", geo: [13.7782234,100.4763161], addr: "เลขที่ 7/222 ศูนย์การค้าเซ็นทรัลพลาซา ปิ่นเกล้า ห้องเลขที่ 330-331 ชั้น 3 ถนนบรมราชชนนี"},
            {name: "เซ็นทรัล พระราม 2 JIB", name_th: "เซ็นทรัล พระราม 2 JIB", tel: "-", geo: [13.663788,100.4370129], addr: "เลขที่ 128 หมู่ 6 ศูนย์การค้าเซ็นทรัลพลาซา พระราม 2 ห้องเลขที่ 345 ชั้น 3 ถนนพระราม2 "},
            {name: "เดอะมอลล์ งามวงศ์วาน", name_th: "เดอะมอลล์ งามวงศ์วาน", tel: "-", geo: [13.8552931,100.5398328], addr: "เลขที่ 428 408,410,412,414,416,418,420,422,424,426,430 ศูนย์การค้าเดอะมอลล์ งามวงศ์วาน ห้องเลขที่ 606 ชั้น 6 ถนนงามวงศ์วาน "},
            {name: "โรบินสัน ลาดกระบัง", name_th: "โรบินสัน ลาดกระบัง", tel: "-", geo: [13.7208488,100.7224779], addr: "เลขที่ 71 ห้างสรรพสินค้าโรบินสัน ลาดกระบัง ห้องเลขที่ 212 ชั้น 2 ถนนลาดกระบัง "},
            {name: "เซ็นทรัล แจ้งวัฒนะ ASUS", name_th: "เซ็นทรัล แจ้งวัฒนะ ASUS", tel: "-", geo: [13.9038463,100.5281431], addr: "เลขที่ 99/99 ศูนย์การค้าเซ็นทรัลพลาซา แจ้งวัฒนะ ห้องเลขที่ 438 ชั้น 4 ถนนแจ้งวัฒนะ "},
            {name: "ฟอร์จูนทาวน์ 2", name_th: "ฟอร์จูนทาวน์ 2", tel: "-", geo: [13.75851,100.56517], addr: " เลขที่ 1,3,5,7 ศูนย์การค้าฟอร์จูนทาวน์ ห้องเลขที่ 3E43-44 ชั้น 3 ถนนรัชดาภิเษก "},
            {name: "ฟิวเจอร์พาร์ค รังสิต 2 MINE", name_th: "ฟิวเจอร์พาร์ค รังสิต 2 MINE", tel: "-", geo: [13.989181514312895,100.6186209352377], addr: "เลขที่ 94 ศูนย์การค้าฟิวเจอร์พาร์ค รังสิต ห้องเลขที่ PLZ.3.FFK014 ชั้น 3 ถนนพหลโยธิน "},
            {name: "ฟิวเจอร์พาร์ค รังสิต MSI", name_th: "ฟิวเจอร์พาร์ค รังสิต MSI", tel: "-", geo: [13.989181514312895,100.6186209352377], addr: "เลขที่ 94 ศูนย์การค้าฟิวเจอร์พาร์ค รังสิต ห้องเลขที่ PLZ.3.ITK056-061 ชั้น 3 ถนนพหลโยธิน"},
            {name: "มาร์เก็ตวิลเลจ สุวรรณภูมิ", name_th: "มาร์เก็ตวิลเลจ สุวรรณภูมิ", tel: "-", geo: [13.632452,100.7091683], addr: "99/29 ห้องเลขที่ S257-258 ชั้น2 หมู่ 1 ถนนเทพรัตน"},
            {name: " เซ็นทรัลเวิลด์ JIB", name_th: " เซ็นทรัลเวิลด์ JIB", tel: "-", geo: [13.7465966,100.5371728], addr: "เลขที่ 4, 4/1-4/2, 4/4 ศูนย์การค้าเซ็นทรัลเวิลด์ ห้องเลขที่ A412 ชั้น 4 ถนนราชดำริ"},
            {name: "เดอะมอลล์ ท่าพระ MINE", name_th: "เดอะมอลล์ ท่าพระ MINE", tel: "-", geo: [13.713286,100.4796143], addr: "เลขที่ 129 ศูนย์การค้าเดอะมอลล์ ท่าพระ ห้องเลขที่ 116,117/1 ชั้น 1 ถนนรัชดาภิเษก (ท่าพระตัดใหม่)"},
            {name: "ฟอร์จูนทาวน์ 1", name_th: "ฟอร์จูนทาวน์ 1", tel: "-", geo: [13.75851,100.56517], addr: " เลขที่ 1,3,5,7 ศูนย์การค้าฟอร์จูนทาวน์ ห้องเลขที่ 3067 ชั้น 3 ถนนรัชดาภิเษก "},
            {name: "เทอมินอล 21 พระราม 3", name_th: "เทอมินอล 21 พระราม 3", tel: "-", geo: [13.6895582,100.5055475], addr: "เลขที่ 3766 ศูนย์การค้าเทอมินอล 21 พระราม 3 ห้องเลขที่ 3044 ชั้น 3 ถนนพระราม 3"},
            {name: "โลตัส นอร์ธ ราชพฤกษ์", name_th: "โลตัส นอร์ธ ราชพฤกษ์", tel: "-", geo: [13.912309,100.451485], addr: "โลตัส นอร์ธ ราชพฤกษ์ ห้องเลขที่ 5184PG ชั้น 1 ถนนราชพฤกษ์"},
            {name: "โรบินสันไลฟ์ไตล์ ราชพฤกษ์", name_th: "โรบินสันไลฟ์ไตล์ ราชพฤกษ์", tel: "-", geo: [13.935552,100.4559951], addr: "ศูนย์การค้าโรบินสันไลฟ์ไตล์ ราชพฤกษ์ ห้องเลขที 209/1-2 ชั้น 2"},
            {name: "เชียงใหม่ 2 (ซีเอ็ม)", name_th: "เชียงใหม่ 2 (ซีเอ็ม)", tel: "053-410-501", geo: [18.8114179247,98.9830827713], addr: "เลขที่ 108 ตึกซีเอ็ม คอมพิวเตอร์ ห้องเลขที่ A126 ถนนเชียงใหม่ - ลำปาง "},
            {name: "แพร่ (CB)", name_th: "แพร่ (CB)", tel: "054-531-944", geo: [18.1314953,100.1456063], addr: "เลขที่ 2/61-62 ถนนยันตรกิจโกศล "},
            {name: "อุตรดิตถ์ (ฟรายเดย์)", name_th: "อุตรดิตถ์ (ฟรายเดย์)", tel: "055-832-892", geo: [17.615088,100.092007], addr: "เลขที่ 172 ห้างสรรพสินค้าฟรายเดย์ ห้องเลขที่ ช๊อป 1 ชั้น 2 ถ.บรมอาสน์"},
            {name: "เซ็นทรัล เชียงราย ", name_th: "เซ็นทรัล เชียงราย ", tel: "053-179-774", geo: [19.886932,99.835081], addr: "เลขที่ 99/9 หมู่ 13 ศูนย์การค้าเซ็นทรัลพลาซา เชียงราย ห้องเลขที่ G23-G24 ชั้น G"},
            {name: "เชียงใหม่ 6 (ไอคอนสแควร์)", name_th: "เชียงใหม่ 6 (ไอคอนสแควร์)", tel: "053-226-167", geo: [18.795828,98.985805], addr: "เลขที่ 29 อาคารไอคอนสแควร์ ห้องเลขที่ B125-B126 ชั้น 1 ถนนหัสดิเสวี"},
            {name: "เซ็นทรัล ลำปาง", name_th: "เซ็นทรัล ลำปาง", tel: "054-811-941 ", geo: [18.2821428,99.4923622], addr: "เลขที่ 319 ศูนย์การค้าเซ็นทรัลพลาซา ลำปาง ห้องเลขที่ 231 ชั้น 2 ถนนไฮเวย์ลำปาง-งาว"},
            {name: "เซ็นทรัล เชียงใหม่ 7 (แอร์พอร์ต)", name_th: "เซ็นทรัล เชียงใหม่ 7 (แอร์พอร์ต)", tel: "053-277-643", geo: [18.769673,98.975884], addr: "เลขที่ 2 ศูนย์การค้าเซ็นทรัลพลาซา เชียงใหม่ แอร์พอร์ต ห้องเลขที่ 373/1-2 ชั้น 3 ถนนมหิดล"},
            {name: "ลำพูน (แจ่มฟ้า)", name_th: "ลำพูน (แจ่มฟ้า)", tel: "-", geo: [18.558916,99.039161], addr: "เลขที่ 179/1 หมู่ที่ 5 ศูนย์การค้าแจ่มฟ้า ช้อปปิ้งมอลล์ ห้องเลขที่ R204 ชั้น 2"},
            {name: "เพชรบูรณ์ (CB)", name_th: "เพชรบูรณ์ (CB)", tel: "056-713-411", geo: [16.4075138,101.1615772], addr: "เลขที่ 54/10,54/11 ถนนเทพาพัฒนา"},
            {name: "เซ็นทรัลเฟสติวัล เชียงใหม่ ", name_th: "เซ็นทรัลเฟสติวัล เชียงใหม่ ", tel: "-", geo: [18.807268,99.0159333], addr: "เลขที่ 99,99/1,99/2 หมู่ 4 ศูนย์การค้าเซ็นทรัลเฟสติวัล เชียงใหม่ ห้องเลขที่ 357 ชั้น 3 ถนนซุปเปอร์ไฮเวย์"},
            {name: "กำแพงเพชร (CB)", name_th: "กำแพงเพชร (CB)", tel: "055-026-454", geo: [16.4732121,99.5336024], addr: "เลขที่ 271-273 ถนนเจริญสุข"},
            {name: "เชียงใหม่ 9 (คอมพลาซ่า)", name_th: "เชียงใหม่ 9 (คอมพลาซ่า)", tel: "-", geo: [18.7825793,98.9700355], addr: "เลขที่ 312/1 ศูนย์การค้าคอมพิวเตอร์ พลาซ่า ห้องเลขที่ A10 ชั้น 1 ถนนมณีนพรัตน์ "},
            {name: "น่าน (CB)", name_th: "น่าน (CB)", tel: "-", geo: [18.78042,100.7725], addr: "เลขที่ 94/5 ถนนอนันตวรฤทธิเดช"},
            {name: "พะเยา (CB)", name_th: "พะเยา (CB)", tel: "-", geo: [19.1724841,99.8944619], addr: "เลขที่ 670/8, 10, 11"},
            {name: "พิจิตร (CB)", name_th: "พิจิตร (CB)", tel: "-", geo: [16.44239,100.3388], addr: "เลขที่ 50/7-8 ถนนสระหลวง"},
            {name: "สุโขทัย (CB)", name_th: "สุโขทัย (CB)", tel: "-", geo: [17.016389,99.8188113], addr: "เลขที่ 386/5 และ 386/6 ถนนจรดวิถีถ่อง"},
            {name: "พิษณุโลก 1 (ท็อปแลนด์)", name_th: "พิษณุโลก 1 (ท็อปแลนด์)", tel: "055-252-275", geo: [16.815584,100.263003], addr: "เลขที่ 83/9 ศูนย์การค้าท็อป ไอที ห้องเลขที่ 2A-002, 2A-003 ชั้น 2A ถนนบรมโตรโลกนารถ"},
            {name: "สิงห์บุรี (ไชยแสง)", name_th: "สิงห์บุรี (ไชยแสง)", tel: "-", geo: [14.896692,100.399058], addr: "เลขที่ 910 ห้างไชยแสงดีพาร์ทเม้นท์สโตร์ ชั้น 3 (ข้างโรงหนัง) ถ.ขุนสรรค์ "},
            {name: "นครสวรรค์ 1 (CB)", name_th: "นครสวรรค์ 1 (CB)", tel: "056-223-244", geo: [15.697582,100.126305], addr: "เลขที่ 266/3,266/4 ถนนสวรรค์วิถี"},
            {name: "ฉะเชิงเทรา 1 (ตะวันออกคอมเพล็กซ์)", name_th: "ฉะเชิงเทรา 1 (ตะวันออกคอมเพล็กซ์)", tel: "038-822-151", geo: [13.6604807,101.0939164], addr: "เลขที่ 55/1 หมู่ 4 ห้างตะวันออกคอมเพล็กซ์ ฉะเชิงเทรา ห้องเลขที่ D1 ชั้น 1"},
            {name: "อยุธยา (CB)", name_th: "อยุธยา (CB)", tel: "-", geo: [14.347896141198893,100.60597345232964], addr: "เลขที่ 55/70-73 ถนนโรจนะ"},
            {name: "สุพรรณบุรี (โรบินสัน)", name_th: "สุพรรณบุรี (โรบินสัน)", tel: "035-454-274", geo: [14.594216,100.003052], addr: "เลขที่ 449 หมู่ 5 ห้างสรรพสินค้าโรบินสัน สุพรรณบุรี ห้องเลขที่ 2F-B-210 ชั้น 2F โซน IT"},
            {name: "ลพบุรี (CB)", name_th: "ลพบุรี (CB)", tel: "-", geo: [14.793135,100.670206], addr: "เลขที่ 99/7 หมู่ที่ 1 "},
            {name: "สระบุรี (โรบินสัน)", name_th: "สระบุรี (โรบินสัน)", tel: "036-351-473", geo: [14.542000,100.951000], addr: "เลขที่ 99 หมู่ 7 ห้างสรรพสินค้าโรบินสัน สระบุรี ห้องเลขที่ 2F-B-214 ชั้น 2F "},
            {name: "นครสวรรค์ 2 (วีสแควร์)", name_th: "นครสวรรค์ 2 (วีสแควร์)", tel: "056-233-433", geo: [15.694627,100.121806], addr: "เลขที่ 320/11 ศูนย์การค้าวีสแควร์ ห้องเลขที B113 ชั้น B ถ.สวรรค์วิถี"},
            {name: "ฉะเชิงเทรา 2 (โรบินสัน)", name_th: "ฉะเชิงเทรา 2 (โรบินสัน)", tel: "038-564-258", geo: [13.6684381,101.0483719], addr: " เลขที่ 910 ห้างสรรพสินค้าโรบินสัน ฉะเชิงเทรา ห้องเลขที่ 2F-B-205 ชั้น 2F IT ZONE ถ.ฉะเชิงเทรา-บางปะกง"},
            {name: "เซ็นทรัล พิษณุโลก 3", name_th: "เซ็นทรัล พิษณุโลก 3", tel: "055-338-423", geo: [16.821659,100.263306], addr: "เลขที่ 9/99 หมู่ 5 ศูนย์การค้าเซ็นทรัลพลาซา พิษณุโลก ห้องเลขที่ 212-213 ชั้น 2 ถนนสิงห์วัฒน์"},
            {name: "อยุธยา ซิตี้พาร์ค ", name_th: "อยุธยา ซิตี้พาร์ค ", tel: "-", geo: [14.337008,100.610128], addr: "เลขที่ 126 หมู่ 2 ศูนย์การค้าอยุธยา ซิตี้พาร์ค ห้องเลขที่ MI-54 ชั้น 2 ถนนสายเอเชีย"},
            {name: "สุพรรณบุรี (CB)", name_th: "สุพรรณบุรี (CB)", tel: "035-526-179", geo: [14.472653448652018,100.12316275575203], addr: "เลขที่ 74/62-63 "},
            {name: "เซ็นทรัล อยุธยา", name_th: "เซ็นทรัล อยุธยา", tel: "-", geo: [14.3316013,100.6122818], addr: "เลขที่ 129/1 ศูนย์การค้าเซ็นทรัล อยุธยา ห้องเลขที่ 109-110 ชั้น 1"},
            {name: "อ่างทอง (CB)", name_th: "อ่างทอง (CB)", tel: "-", geo: [14.59331,100.4517], addr: "เลขที่ 2 ถนนเทศบาล"},
            {name: "ชัยนาท (CB)", name_th: "ชัยนาท (CB)", tel: "-", geo: [15.1869585,100.1238302], addr: "เลขที่ 90-3-4 ถนนพรหมประเสริฐ "},
            {name: "อุทัยธานี (CB)", name_th: "อุทัยธานี (CB)", tel: "-", geo: [15.387188,100.022926], addr: "เลขที่ 90/10-11 ถนนเติบศิริ"},
            {name: "สมุทรสงคราม (CB)", name_th: "สมุทรสงคราม (CB)", tel: "-", geo: [13.4113385,100.0030114], addr: "เลขที่ 7/79-80 ถนนเอกชัย"},
            {name: "นครนายก (CB)", name_th: "นครนายก (CB)", tel: "-", geo: [14.2046,101.209917], addr: "เลขที่ 2-255/6-7 ถนนรังสิต-นครนายก"},
            {name: "เซ็นทรัล เวสต์เกต JIB", name_th: "เซ็นทรัล เวสต์เกต JIB", tel: "-", geo: [13.876609,100.411690], addr: "เลขที่ 199,199/1,199/2 หมู่ 6 ศูนย์การค้าเซ็นทรัลพลาซา เวสต์เกต ห้องเลขที่ 292 ชั้น 2 "},
            {name: "เซ็นทรัล ศาลายา 2 MINE ", name_th: "เซ็นทรัล ศาลายา 2 MINE ", tel: "-", geo: [13.7868135,100.2761419], addr: "เลขที่ 99/19-20 หมู่ 2 ศูนย์การค้าเซ็นทรัลพลาซา ศาลายา ห้องเลขที่ 216/1 ชั้น 2 "},
            {name: "ฟอร์จูนทาวน์ 3", name_th: "ฟอร์จูนทาวน์ 3", tel: "-", geo: [13.759774,100.565461], addr: "เลขที่ 1,3,5,7 ศูนย์การค้าฟอร์จูนทาวน์ ห้องเลขที่ 4P10 ชั้น 4 ถนนรัชดาภิเษก "},
            {name: "มาร์เก็ตวิลเลจ รังสิต", name_th: "มาร์เก็ตวิลเลจ รังสิต", tel: "-", geo: [14.00113,100.6825453], addr: "เลขที่ 98 หมู่ 2 ศูนย์การค้ามาร์เก็ตวิลเลจ รังสิต ห้องเลขที่ S109-110 ชั้น 1 ถนนรังสิต-นครนายก"},
            {name: "ราชบุรี (ไอทีซันนี่)", name_th: "ราชบุรี (ไอทีซันนี่)", tel: "032-350-539", geo: [13.537062,99.819420], addr: "เลขที่ 11 ศูนย์การค้ารอยัล พาร์ค (ไอทีซันนี่) ห้องเลขที่ 202-203,204-205 ชั้น 2 ถนนคฑาธร "},
            {name: "เพชรบุรี (CB)", name_th: "เพชรบุรี (CB)", tel: "-", geo: [13.082056,99.949417], addr: "เลขที่ 222/3-4 หมู่ 6 "},
            {name: "ราชบุรี (CB)", name_th: "ราชบุรี (CB)", tel: "032-322-025", geo: [13.534452,99.808810], addr: "เลขที่ 260/45 ถนนสุริยวงศ์"},
            {name: "ประจวบ-หัวหิน (มาเก็ตวิลเลจ)", name_th: "ประจวบ-หัวหิน (มาเก็ตวิลเลจ)", tel: "032-526-159", geo: [12.557299,99.960632], addr: "เลขที่ 234/1 ศูนย์การค้ามาร์เก็ตวิลเลจ หัวหิน ห้องเลขที่ A316 ชั้น 3 ถนนเพชรเกษม"},
            {name: "กาญจนบุรี (โรบินสัน)", name_th: "กาญจนบุรี (โรบินสัน)", tel: "034-603-296", geo: [14.0227521,99.5534815], addr: "เลขที่ 110 หมู่ 9 ห้างสรรพสินค้าโรบินสัน กาญจนบุรี ห้องเลขที่ 2F-B-209 ชั้น 2F"},
        ]
    },
}
