...
var shpfile = new L.Shapefile('public_park.zip', {
    onEachFeature: function(feature, layer) {
        // console.log(feature)
        console.log(layer)
        layer.bindPopup(`
            <p>${layer.feature.properties.park_name}</p>
            <p>${layer.feature.properties.open_close}</p>
            <p>${layer.feature.properties.tel}</p>
            `)
        L.donut([layer._latlng.lat,layer._latlng.lng], {
            radius: 800,
            innerRadius: 0,
