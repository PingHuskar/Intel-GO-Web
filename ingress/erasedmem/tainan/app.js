      ...
      L.marker([lat,lng], {
        ...
        try {
            ...
            .bindPopup(
                ...
                console.log(`e`)
                try {
                    L.marker([detail.at(3) / 10 ** 6,detail.at(4) / 10 ** 6])
                    .addTo(map);
                } catch (er) {
                    console.log(`er`)
                    // try {
                    //     L.marker([detail.at(4) / 10 ** 6,detail.at(5) / 10 ** 6])
                    //     .addTo(map);
                    // } catch (err) {
                    //     console.log(`err`)
                    // }
